...
public class DatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean webEntityManagerFactory(
        ...
        return builder
                ...
                .packages("com.weborder.ordersystem.domain.web")  // Web 엔티티 패키지
                .persistenceUnit("web")
    ...
    public LocalContainerEntityManagerFactoryBean erpEntityManagerFactory(
        ...
        return builder
                .dataSource(dataSource)
                .packages("com.weborder.ordersystem.domain.erp")  // ERP 엔티티 패키지
                .persistenceUnit("erp")
    ...
    // ERP DB JPA 속성 설정 (읽기 전용 - 안전)
    private java.util.Map<String, Object> erpJpaProperties() {
        java.util.Map<String, Object> props = new java.util.HashMap<>();
        props.put("hibernate.hbm2ddl.auto", "validate");  // ERP DB - 실제 스키마와 엔티티 일치 검증
        props.put("hibernate.show_sql", "false");
        props.put("hibernate.format_sql", "false");
        props.put("hibernate.dialect", "org.hibernate.dialect.MySQLDialect");
        return props;
...
@EnableJpaRepositories(
        basePackages = "com.weborder.ordersystem.domain.web",
...
@Configuration
@EnableJpaRepositories(
        basePackages = "com.weborder.ordersystem.domain.erp", 
