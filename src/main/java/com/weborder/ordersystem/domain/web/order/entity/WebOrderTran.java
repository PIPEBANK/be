...
public class WebOrderTran {
    ...
    private Integer orderTranLdiv; //판매가미반영
    ...
    @Column(name = "ORDER_TRAN_CUSTOMITEM")
    private Long orderTranCustomitem; //커스텀아이템코드
    ...
    public WebOrderTran(String orderTranDate, Integer orderTranSosok, String orderTranUjcd, Integer orderTranAcno,
                       ...
                       LocalDateTime orderTranLdate, String orderTranLuser, Long orderTranCustomitem) {
        ...
        this.orderTranCustomitem = orderTranCustomitem;
    }
    ...
    public void updateCustomItemPrice(BigDecimal rate, String spec, String unit, Integer vdiv, String luser) {
        ...
        BigDecimal net = rate.multiply(this.orderTranCnt);
        this.orderTranNet = net;
        if (this.orderTranVdiv == 1) {
            this.orderTranVat = net.divide(BigDecimal.TEN, 0, java.math.RoundingMode.HALF_UP);
        } else {
            this.orderTranVat = BigDecimal.ZERO;
        }
