...
public class ShipTran {
    ...
    private String shipTranDeta; // 품목명
    ...
    private Integer shipTranCalc; // 정산여부

    @Column(name = "SHIP_TRAN_VDIV", columnDefinition = "tinyint(3)", nullable = false)
    private Integer shipTranVdiv; // 부가세여부

    @Column(name = "SHIP_TRAN_ADIV", columnDefinition = "tinyint(3)", nullable = false)
    private Integer shipTranAdiv; // 예수금여부

    @Column(name = "SHIP_TRAN_RATE", precision = 18, scale = 2, nullable = false)
    ...
    @Column(name = "SHIP_TRAN_DC_AMT", precision = 18, scale = 2, nullable = false)
    private BigDecimal shipTranDcAmt; // 할인금액

    @Column(name = "SHIP_TRAN_AMT", precision = 18, scale = 2, nullable = false)
    ...
    private BigDecimal shipTranAdv; // 예수금
    ...
    @Column(name = "SHIP_TRAN_LRATE", precision = 18, scale = 2, nullable = false)
    private BigDecimal shipTranLrate; // 이전판매단가

    @Column(name = "SHIP_TRAN_PRICE", precision = 18, scale = 2, nullable = false)
    private BigDecimal shipTranPrice; // 매입가

    @Column(name = "SHIP_TRAN_PRICE2", precision = 18, scale = 2, nullable = false)
    private BigDecimal shipTranPrice2; // 매입가증감

    @Column(name = "SHIP_TRAN_LDIV", columnDefinition = "tinyint(3)", nullable = false)
    private Integer shipTranLdiv; // 판매가미반영
    ...
    public ShipTran(String shipTranDate, Integer shipTranSosok, String shipTranUjcd, Integer shipTranAcno,
                    Integer shipTranSeq, String shipTranDcod, Integer shipTranItem,
                    String shipTranDeta, String shipTranSpec, String shipTranUnit,
                    Integer shipTranCalc, Integer shipTranVdiv, Integer shipTranAdiv,
                    BigDecimal shipTranRate, BigDecimal shipTranDcPer, BigDecimal shipTranDcAmt, BigDecimal shipTranAmt,
                    BigDecimal shipTranCnt, BigDecimal shipTranNet, BigDecimal shipTranVat,
                    ...
                    String shipTranRemark, LocalDateTime shipTranFdate, String shipTranFuser,
                    LocalDateTime shipTranLdate, String shipTranLuser) {
    ...
    public void updateLuser(String luser) {
        this.shipTranLdate = LocalDateTime.now();
        this.shipTranLuser = luser;
    }
