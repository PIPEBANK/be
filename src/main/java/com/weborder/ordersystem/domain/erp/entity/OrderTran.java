...
@ToString
@IdClass(OrderTran.OrderTranId.class)
public class OrderTran {
    ...
    @Id
    @Column(name = "ORDER_TRAN_SOSOK", columnDefinition = "int(11)", nullable = false)
    ...
    @Id
    @Column(name = "ORDER_TRAN_ACNO", columnDefinition = "int(11)", nullable = false)
    private Integer orderTranAcno;

    @Id
    @Column(name = "ORDER_TRAN_SEQ", columnDefinition = "int(11)", nullable = false)
    private Integer orderTranSeq;

    @Column(name = "ORDER_TRAN_ITEM", columnDefinition = "int(11)", nullable = false)
    ...
    @Column(name = "ORDER_TRAN_RATE", precision = 18, scale = 2, nullable = false)
    private BigDecimal orderTranRate; // 기본단가

    @Column(name = "ORDER_TRAN_CNT", precision = 18, scale = 0, nullable = false)
    ...
    @Column(name = "ORDER_TRAN_DC_AMT", precision = 18, scale = 2, nullable = false)
    private BigDecimal orderTranDcAmt; // 할인금액

    @Column(name = "ORDER_TRAN_AMT", precision = 18, scale = 2, nullable = false)
    ...
    @Column(name = "ORDER_TRAN_LRATE", precision = 18, scale = 2, nullable = false)
    private BigDecimal orderTranLrate; // 이전판매단가

    @Column(name = "ORDER_TRAN_PRICE", precision = 18, scale = 2, nullable = false)
    private BigDecimal orderTranPrice; // 매입가

    @Column(name = "ORDER_TRAN_PRICE2", precision = 18, scale = 2, nullable = false)
    ...
    @Builder
    public OrderTran(String orderTranDate, Integer orderTranSosok, String orderTranUjcd, Integer orderTranAcno,
                    Integer orderTranSeq, Integer orderTranItem, String orderTranDeta,
                    String orderTranSpec, String orderTranUnit, Integer orderTranCalc, Integer orderTranVdiv,
                    Integer orderTranAdiv, BigDecimal orderTranRate, BigDecimal orderTranCnt,
                    BigDecimal orderTranDcPer, BigDecimal orderTranDcAmt, BigDecimal orderTranAmt,
                    ...
                    LocalDateTime orderTranLdate, String orderTranLuser) {
    ...
    public void updateStau(String stau, String luser) {
        this.orderTranStau = stau;
        this.orderTranLdate = LocalDateTime.now();
        this.orderTranLuser = luser;
    }

    public void updateCustomItemPrice(java.math.BigDecimal rate, String spec, String unit, Integer vdiv, String luser) {
        this.orderTranRate = rate;
        this.orderTranAmt = rate;
        this.orderTranSpec = spec != null ? spec : "";
        this.orderTranUnit = unit != null ? unit : "";
        if (vdiv != null) this.orderTranVdiv = vdiv;

        java.math.BigDecimal net = rate.multiply(this.orderTranCnt);
        this.orderTranNet = net;
        if (this.orderTranVdiv == 1) {
            this.orderTranVat = net.divide(java.math.BigDecimal.TEN, 0, java.math.RoundingMode.HALF_UP);
        } else {
            this.orderTranVat = java.math.BigDecimal.ZERO;
        }
        this.orderTranTot = this.orderTranNet.add(this.orderTranVat);
        this.orderTranLdate = LocalDateTime.now();
        this.orderTranLuser = luser;
    }
    ...
    @Getter
    @NoArgsConstructor
    public static class OrderTranId implements Serializable {
        private String orderTranDate;
        private Integer orderTranSosok;
        private String orderTranUjcd;
        private Integer orderTranAcno;
        ...
        public OrderTranId(String orderTranDate, Integer orderTranSosok, String orderTranUjcd, Integer orderTranAcno, Integer orderTranSeq) {
            this.orderTranDate = orderTranDate;
            this.orderTranSosok = orderTranSosok;
            this.orderTranUjcd = orderTranUjcd;
            this.orderTranAcno = orderTranAcno;
        ...
        public boolean equals(Object o) {
            ...
            OrderTranId that = (OrderTranId) o;
