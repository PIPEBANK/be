...
public class Customer {
    ...
    private String custCodePart2; //업종

    @Column(name = "CUST_CODE_UNAME1", nullable = false, length = 50)
    private String custCodeUname1; //대표자

    @Column(name = "CUST_CODE_UTEL1", nullable = false, length = 50)
    private String custCodeUtel1; //연락처

    @Column(name = "CUST_CODE_UNAME2", nullable = false, length = 50)
    private String custCodeUname2; //담당자

    @Column(name = "CUST_CODE_UTEL2", nullable = false, length = 50)
    private String custCodeUtel2; //연락처-담당자
    ...
    @Column(name = "CUST_CODE_FAX", nullable = false, length = 50)
    ...
    private Integer custCodeUseAcc; //회계사용

    @Column(name = "CUST_CODE_USE_PUR", nullable = false, columnDefinition = "tinyint(3)")
    private Integer custCodeUsePur; //구매자재사용

    @Column(name = "CUST_CODE_USE_POS", nullable = false, columnDefinition = "tinyint(3)")
    private Integer custCodeUsePos; //업장사용

    @Column(name = "CUST_CODE_BUBIN", nullable = false, length = 20)
    ...
    @Column(name = "CUST_CODE_HIDE_PRICE", nullable = false, columnDefinition = "tinyint(3) default 0")
    private Integer custCodeHidePrice; //단가숨김 (0=표시, 1=미표시)

    @Column(name = "CUST_CODE_ROOMS", nullable = false, columnDefinition = "int(10) default 0")
    private Integer custCodeRooms; //객실수

    @Column(name = "CUST_CODE_REMARK", nullable = false, length = 200)
    ...
    @Builder
    public Customer(Integer custCodeCode, String custCodeNum, String custCodeDcod, String custCodeName, String custCodeWord,
                   String custCodeAnam, String custCodeSano, String custCodePart1,
                   ...
                   BigDecimal custCodeMcharge, String custCodePtype, Integer custCodeHidePrice,
                   Integer custCodeRooms,
                   String custCodeRemark, LocalDateTime custCodeFdate, String custCodeFuser,
                   LocalDateTime custCodeLdate, String custCodeLuser) {
        this.custCodeCode = custCodeCode;
        ...
        this.custCodeHidePrice = custCodeHidePrice != null ? custCodeHidePrice : 0;
        this.custCodeRooms = custCodeRooms != null ? custCodeRooms : 0;
    ...
    public boolean isHidePrice() {
        return custCodeHidePrice != null && custCodeHidePrice == 1;
    }

    public void setHidePrice(boolean hide) {
        this.custCodeHidePrice = hide ? 1 : 0;
    }

    public void updateInfo(String custCodeNum, String custCodeName, String custCodeSano,
                           String custCodePart1, String custCodePart2,
                           String custCodeUname1, String custCodeUname2,
                           String custCodeUtel1, String custCodeUtel2,
                           String custCodeFax, String custCodeEmail,
                           String custCodePost, String custCodeAddr1,
                           String custCodeAddr2, String custCodeAddr,
                           String custCodeRemark,
                           Integer custCodeUseAcc, Integer custCodeUsePur, Integer custCodeUsePos,
                           Integer custCodeRooms,
                           String luser) {
        this.custCodeNum = custCodeNum;
        this.custCodeName = custCodeName;
        ...
        this.custCodeAddr = custCodeAddr;
        this.custCodeRemark = custCodeRemark;
        if (custCodeUseAcc != null) this.custCodeUseAcc = custCodeUseAcc;
        if (custCodeUsePur != null) this.custCodeUsePur = custCodeUsePur;
        if (custCodeUsePos != null) this.custCodeUsePos = custCodeUsePos;
        if (custCodeRooms != null) this.custCodeRooms = custCodeRooms;
        this.custCodeLdate = LocalDateTime.now();
        this.custCodeLuser = luser;
    }
}
