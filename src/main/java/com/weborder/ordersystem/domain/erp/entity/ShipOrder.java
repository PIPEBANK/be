...
public class ShipOrder {
    ...
    @Id
    @Column(name = "SHIP_ORDER_SOSOK", columnDefinition = "int(11)", nullable = false)
    ...
    @Id
    @Column(name = "SHIP_ORDER_ACNO", columnDefinition = "int(11)", nullable = false)
    private Integer shipOrderAcno; // 출하번호

    @Id
    @Column(name = "SHIP_ORDER_SEQ", columnDefinition = "int(11)", nullable = false)
    ...
    @Column(name = "SHIP_ORDER_OACNO", columnDefinition = "int(11)", nullable = false)
    private Integer shipOrderOacno; // 주문번호

    @Column(name = "SHIP_ORDER_OSEQ", columnDefinition = "int(11)", nullable = false)
